...
import logoNHSD from '@/images/clients/nhs-england/logo-colour-dark.png'
  ...
  return (
    <>
      ...
      <Testimonial
        ...
        client={{ name: 'University of Sheffield', logo: logoUoS }}
      >
        [Ologist] nurtured, empowered, and impacted people, ensuring they understood
        the strategy and benefits, and received the necessary training and support.
      </Testimonial>
